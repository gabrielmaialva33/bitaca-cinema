...
Comprehensive Firebase-based voting system for the Bitaca Cinema project, allowing users to authenticate, take a
knowledge quiz, and vote on film productions using a 5-star rating system.
